...
<tr><legend> Adresse mail :</legend>
    <legend> <input type="text" class="form-control" required pattern="^[a-z0-9._-]+@[a-z0-9._-]+\.[a-z]{2,6}$" name="mail"></legend>
</tr>
...
<p class="box-register">Vous avez déjà un compte? <a href="login.php">Connexion</a></p>
</form>
</div>
</div>
</div>
